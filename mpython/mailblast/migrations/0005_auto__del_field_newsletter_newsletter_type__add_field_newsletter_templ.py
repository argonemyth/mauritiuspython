...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Newsletter.newsletter_type'
        db.delete_column('mailblast_newsletter', 'newsletter_type')

        # Adding field 'Newsletter.template'
        db.add_column('mailblast_newsletter', 'template',
                      self.gf('django.db.models.fields.CharField')(default='default', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Newsletter.use_html'
        db.add_column('mailblast_newsletter', 'use_html',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Newsletter.newsletter_type'
        raise RuntimeError("Cannot reverse this migration. 'Newsletter.newsletter_type' and its values cannot be restored.")
        # Deleting field 'Newsletter.template'
        db.delete_column('mailblast_newsletter', 'template')

        # Deleting field 'Newsletter.use_html'
        db.delete_column('mailblast_newsletter', 'use_html')
